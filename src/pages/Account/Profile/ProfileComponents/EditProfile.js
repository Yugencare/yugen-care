...
export default function EditProfile({ profile }) {
  ...
  const { details, HasDetails } = useSelector((state) => state.loginUser);
  ...
  const [selectedDate, setSelectedDate] = useState(new Date(profile?.dob));
